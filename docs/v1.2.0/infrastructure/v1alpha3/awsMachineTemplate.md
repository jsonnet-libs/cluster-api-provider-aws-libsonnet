---
permalink: /v1.2.0/infrastructure/v1alpha3/awsMachineTemplate/
---

# infrastructure.v1alpha3.awsMachineTemplate
  ...
  * [`obj spec.template`](#obj-spectemplate)
    * [`obj spec.template.spec`](#obj-spectemplatespec)
      ...
      * [`obj spec.template.spec.ami`](#obj-spectemplatespecami)
        * [`fn withArn(arn)`](#fn-spectemplatespecamiwitharn)
        * [`fn withFilters(filters)`](#fn-spectemplatespecamiwithfilters)
        * [`fn withFiltersMixin(filters)`](#fn-spectemplatespecamiwithfiltersmixin)
        * [`fn withId(id)`](#fn-spectemplatespecamiwithid)
        * [`obj spec.template.spec.ami.filters`](#obj-spectemplatespecamifilters)
          * [`fn withName(name)`](#fn-spectemplatespecamifilterswithname)
          * [`fn withValues(values)`](#fn-spectemplatespecamifilterswithvalues)
          * [`fn withValuesMixin(values)`](#fn-spectemplatespecamifilterswithvaluesmixin)
...
### fn spec.template.spec.ami.withArn
...
### fn spec.template.spec.ami.withFilters
...
### fn spec.template.spec.ami.withFiltersMixin
...
## obj spec.template.spec.ami.filters

"Filters is a set of key/value pairs used to identify a resource They are applied according to the rules defined by the AWS API: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Filtering.html"

### fn spec.template.spec.ami.filters.withName
...
### fn spec.template.spec.ami.filters.withValues
...
### fn spec.template.spec.ami.filters.withValuesMixin
