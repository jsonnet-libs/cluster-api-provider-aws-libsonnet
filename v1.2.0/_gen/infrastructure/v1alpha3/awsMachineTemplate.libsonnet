{
  ...
  '#':: d.pkg(name='awsMachineTemplate', url='', help='"AWSMachineTemplate is the Schema for the awsmachinetemplates API"'),
    ...
    template: {
      ...
      spec: {
        ...
        ami: {
          ...
          withArn(arn): { spec+: { template+: { spec+: { ami+: { arn: arn } } } } },
          ...
          withFilters(filters): { spec+: { template+: { spec+: { ami+: { filters: if std.isArray(v=filters) then filters else [filters] } } } } },
          ...
          withFiltersMixin(filters): { spec+: { template+: { spec+: { ami+: { filters+: if std.isArray(v=filters) then filters else [filters] } } } } },
        ...
        subnet: {
          '#withArn':: d.fn(help='"ARN of resource"', args=[d.arg(name='arn', type=d.T.string)]),
          withArn(arn): { spec+: { template+: { spec+: { subnet+: { arn: arn } } } } },
          '#withFilters':: d.fn(help='"Filters is a set of key/value pairs used to identify a resource They are applied according to the rules defined by the AWS API: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Filtering.html"', args=[d.arg(name='filters', type=d.T.array)]),
