{
  ...
  '#':: d.pkg(name='awsClusterRoleIdentity', url='', help='"AWSClusterRoleIdentity is the Schema for the awsclusterroleidentities API It is used to assume a role using the provided sourceRef."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSClusterRoleIdentity', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    sourceIdentityRef: {
      ...
      withKind(kind): { spec+: { sourceIdentityRef+: { kind: kind } } },
    ...
    '#withInlinePolicy':: d.fn(help='"An IAM policy as a JSON-encoded string that you want to use as an inline session policy."', args=[d.arg(name='inlinePolicy', type=d.T.string)]),
    withInlinePolicy(inlinePolicy): { spec+: { inlinePolicy: inlinePolicy } },
    '#withPolicyARNs':: d.fn(help='"The Amazon Resource Names (ARNs) of the IAM managed policies that you want to use as managed session policies. The policies must exist in the same account as the role."', args=[d.arg(name='policyARNs', type=d.T.array)]),
    withPolicyARNs(policyARNs): { spec+: { policyARNs: if std.isArray(v=policyARNs) then policyARNs else [policyARNs] } },
    '#withPolicyARNsMixin':: d.fn(help='"The Amazon Resource Names (ARNs) of the IAM managed policies that you want to use as managed session policies. The policies must exist in the same account as the role."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='policyARNs', type=d.T.array)]),
    withPolicyARNsMixin(policyARNs): { spec+: { policyARNs+: if std.isArray(v=policyARNs) then policyARNs else [policyARNs] } },
    '#withRoleARN':: d.fn(help='"The Amazon Resource Name (ARN) of the role to assume."', args=[d.arg(name='roleARN', type=d.T.string)]),
    withRoleARN(roleARN): { spec+: { roleARN: roleARN } },
    '#withSessionName':: d.fn(help='"An identifier for the assumed role session"', args=[d.arg(name='sessionName', type=d.T.string)]),
    withSessionName(sessionName): { spec+: { sessionName: sessionName } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
