{
  ...
  '#':: d.pkg(name='awsClusterControllerIdentity', url='', help='"AWSClusterControllerIdentity is the Schema for the awsclustercontrolleridentities API It is used to grant access to use Cluster API Provider AWS Controller credentials."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSClusterControllerIdentity', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
