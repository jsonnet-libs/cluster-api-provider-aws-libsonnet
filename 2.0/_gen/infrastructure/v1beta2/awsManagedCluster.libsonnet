{
  ...
  '#':: d.pkg(name='awsManagedCluster', url='', help='"AWSManagedCluster is the Schema for the awsmanagedclusters API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSManagedCluster', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'infrastructure.cluster.x-k8s.io/v1beta2',
    kind: 'AWSManagedCluster',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AWSManagedClusterSpec defines the desired state of AWSManagedCluster"'),
  spec: {
