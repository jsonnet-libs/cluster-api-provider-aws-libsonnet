{
  ...
  '#':: d.pkg(name='awsClusterStaticIdentity', url='', help='"AWSClusterStaticIdentity is the Schema for the awsclusterstaticidentities API It represents a reference to an AWS access key ID and secret access key, stored in a secret."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSClusterStaticIdentity', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withSecretRef':: d.fn(help='"Reference to a secret containing the credentials. The secret should contain the following data keys: AccessKeyID: AKIAIOSFODNN7EXAMPLE SecretAccessKey: wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY SessionToken: Optional"', args=[d.arg(name='secretRef', type=d.T.string)]),
    withSecretRef(secretRef): { spec+: { secretRef: secretRef } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
