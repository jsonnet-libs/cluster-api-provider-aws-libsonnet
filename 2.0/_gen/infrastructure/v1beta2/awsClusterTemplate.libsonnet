    ...
    template: {
      ...
      spec: {
        ...
        controlPlaneLoadBalancer: {
          ...
          '#withHealthCheckProtocol':: d.fn(help='"HealthCheckProtocol sets the protocol type for classic ELB health check target default value is ClassicELBProtocolSSL"', args=[d.arg(name='healthCheckProtocol', type=d.T.string)]),
          withHealthCheckProtocol(healthCheckProtocol): { spec+: { template+: { spec+: { controlPlaneLoadBalancer+: { healthCheckProtocol: healthCheckProtocol } } } } },
        ...
        network: {
          ...
          vpc: {
            ...
            ipv6: {
              ...
              withCidrBlock(cidrBlock): { spec+: { template+: { spec+: { network+: { vpc+: { ipv6+: { cidrBlock: cidrBlock } } } } } } },
              ...
              withEgressOnlyInternetGatewayId(egressOnlyInternetGatewayId): { spec+: { template+: { spec+: { network+: { vpc+: { ipv6+: { egressOnlyInternetGatewayId: egressOnlyInternetGatewayId } } } } } } },
              ...
              withPoolId(poolId): { spec+: { template+: { spec+: { network+: { vpc+: { ipv6+: { poolId: poolId } } } } } } },
            },
        ...
        '#s3Bucket':: d.obj(help='"S3Bucket contains options to configure a supporting S3 bucket for this cluster - currently used for nodes requiring Ignition (https://coreos.github.io/ignition/) for bootstrapping (requires BootstrapFormatIgnition feature flag to be enabled)."'),
        s3Bucket: {
          '#withControlPlaneIAMInstanceProfile':: d.fn(help='"ControlPlaneIAMInstanceProfile is a name of the IAMInstanceProfile, which will be allowed to read control-plane node bootstrap data from S3 Bucket."', args=[d.arg(name='controlPlaneIAMInstanceProfile', type=d.T.string)]),
          withControlPlaneIAMInstanceProfile(controlPlaneIAMInstanceProfile): { spec+: { template+: { spec+: { s3Bucket+: { controlPlaneIAMInstanceProfile: controlPlaneIAMInstanceProfile } } } } },
          '#withName':: d.fn(help='"Name defines name of S3 Bucket to be created."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { template+: { spec+: { s3Bucket+: { name: name } } } } },
          '#withNodesIAMInstanceProfiles':: d.fn(help='"NodesIAMInstanceProfiles is a list of IAM instance profiles, which will be allowed to read worker nodes bootstrap data from S3 Bucket."', args=[d.arg(name='nodesIAMInstanceProfiles', type=d.T.array)]),
          withNodesIAMInstanceProfiles(nodesIAMInstanceProfiles): { spec+: { template+: { spec+: { s3Bucket+: { nodesIAMInstanceProfiles: if std.isArray(v=nodesIAMInstanceProfiles) then nodesIAMInstanceProfiles else [nodesIAMInstanceProfiles] } } } } },
          '#withNodesIAMInstanceProfilesMixin':: d.fn(help='"NodesIAMInstanceProfiles is a list of IAM instance profiles, which will be allowed to read worker nodes bootstrap data from S3 Bucket."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodesIAMInstanceProfiles', type=d.T.array)]),
          withNodesIAMInstanceProfilesMixin(nodesIAMInstanceProfiles): { spec+: { template+: { spec+: { s3Bucket+: { nodesIAMInstanceProfiles+: if std.isArray(v=nodesIAMInstanceProfiles) then nodesIAMInstanceProfiles else [nodesIAMInstanceProfiles] } } } } },
        },
