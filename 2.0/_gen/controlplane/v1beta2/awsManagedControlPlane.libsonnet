{
  ...
  spec: {
    ...
    kubeProxy: {
      '#withDisable':: d.fn(help='"Disable set to true indicates that kube-proxy should be disabled. With EKS clusters kube-proxy is automatically installed into the cluster. For clusters where you want to use kube-proxy functionality that is provided with an alternate CNI, this option provides a way to specify that the kube-proxy daemonset should be deleted. You cannot set this to true if you are using the Amazon kube-proxy addon."', args=[d.arg(name='disable', type=d.T.boolean)]),
    ...
    network: {
      ...
      subnets: {
        ...
        withId(id): { id: id },
        '#withIpv6CidrBlock':: d.fn(help='"IPv6CidrBlock is the IPv6 CIDR block to be used when the provider creates a managed VPC. A subnet can have an IPv4 and an IPv6 address. IPv6 is only supported in managed clusters, this field cannot be set on AWSCluster object."', args=[d.arg(name='ipv6CidrBlock', type=d.T.string)]),
        withIpv6CidrBlock(ipv6CidrBlock): { ipv6CidrBlock: ipv6CidrBlock },
        '#withIsIpv6':: d.fn(help='"IsIPv6 defines the subnet as an IPv6 subnet. A subnet is IPv6 when it is associated with a VPC that has IPv6 enabled. IPv6 is only supported in managed clusters, this field cannot be set on AWSCluster object."', args=[d.arg(name='isIpv6', type=d.T.boolean)]),
      ...
      vpc: {
        '#ipv6':: d.obj(help='"IPv6 contains ipv6 specific settings for the network. Supported only in managed clusters. This field cannot be set on AWSCluster object."'),
        ipv6: {
          '#withCidrBlock':: d.fn(help='"CidrBlock is the CIDR block provided by Amazon when VPC has enabled IPv6."', args=[d.arg(name='cidrBlock', type=d.T.string)]),
          ...
          '#withPoolId':: d.fn(help='"PoolID is the IP pool which must be defined in case of BYO IP is defined."', args=[d.arg(name='poolId', type=d.T.string)]),
    ...
    '#oidcIdentityProviderConfig':: d.obj(help='"IdentityProviderconfig is used to specify the oidc provider config to be attached with this eks cluster"'),
    oidcIdentityProviderConfig: {
      '#withClientId':: d.fn(help='"This is also known as audience. The ID for the client application that makes authentication requests to the OpenID identity provider."', args=[d.arg(name='clientId', type=d.T.string)]),
      ...
      '#withGroupsPrefix':: d.fn(help='"The prefix that is prepended to group claims to prevent clashes with existing names (such as system: groups). For example, the valueoidc: will create group names like oidc:engineering and oidc:infra."', args=[d.arg(name='groupsPrefix', type=d.T.string)]),
      ...
      '#withIssuerUrl':: d.fn(help="\"The URL of the OpenID identity provider that allows the API server to discover public signing keys for verifying tokens. The URL must begin with https:// and should correspond to the iss claim in the provider's OIDC ID tokens. Per the OIDC standard, path components are allowed but query parameters are not. Typically the URL consists of only a hostname, like https://server.example.org or https://example.com. This URL should point to the level below .well-known/openid-configuration and must be publicly accessible over the internet.\"", args=[d.arg(name='issuerUrl', type=d.T.string)]),
      withIssuerUrl(issuerUrl): { spec+: { oidcIdentityProviderConfig+: { issuerUrl: issuerUrl } } },
      '#withRequiredClaims':: d.fn(help='"The key value pairs that describe required claims in the identity token. If set, each claim is verified to be present in the token with a matching value. For the maximum number of claims that you can require, see Amazon EKS service quotas (https://docs.aws.amazon.com/eks/latest/userguide/service-quotas.html) in the Amazon EKS User Guide."', args=[d.arg(name='requiredClaims', type=d.T.object)]),
      withRequiredClaims(requiredClaims): { spec+: { oidcIdentityProviderConfig+: { requiredClaims: requiredClaims } } },
      '#withRequiredClaimsMixin':: d.fn(help='"The key value pairs that describe required claims in the identity token. If set, each claim is verified to be present in the token with a matching value. For the maximum number of claims that you can require, see Amazon EKS service quotas (https://docs.aws.amazon.com/eks/latest/userguide/service-quotas.html) in the Amazon EKS User Guide."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredClaims', type=d.T.object)]),
      ...
      '#withUsernameClaim':: d.fn(help='"The JSON Web Token (JWT) claim to use as the username. The default is sub, which is expected to be a unique identifier of the end user. You can choose other claims, such as email or name, depending on the OpenID identity provider. Claims other than email are prefixed with the issuer URL to prevent naming clashes with other plug-ins."', args=[d.arg(name='usernameClaim', type=d.T.string)]),
      withUsernameClaim(usernameClaim): { spec+: { oidcIdentityProviderConfig+: { usernameClaim: usernameClaim } } },
      '#withUsernamePrefix':: d.fn(help='"The prefix that is prepended to username claims to prevent clashes with existing names. If you do not provide this field, and username is a value other than email, the prefix defaults to issuerurl#. You can use the value - to disable all prefixing."', args=[d.arg(name='usernamePrefix', type=d.T.string)]),
    ...
    vpcCni: {
      ...
      '#withDisable':: d.fn(help='"Disable indicates that the Amazon VPC CNI should be disabled. With EKS clusters the Amazon VPC CNI is automatically installed into the cluster. For clusters where you want to use an alternate CNI this option provides a way to specify that the Amazon VPC CNI should be deleted. You cannot set this to true if you are using the Amazon VPC CNI addon."', args=[d.arg(name='disable', type=d.T.boolean)]),
      withDisable(disable): { spec+: { vpcCni+: { disable: disable } } },
